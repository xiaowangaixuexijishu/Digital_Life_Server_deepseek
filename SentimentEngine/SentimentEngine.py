...
class SentimentEngine():
    def __init__(self, model_path):
        ...
        #self.tokenizer = BertTokenizer.from_pretrained(pretrained_model_name_or_path='BertModel/')
        #self.tokenizer = BertTokenizer.from_pretrained("models/bert-base-chinese/")
        self.bert_path = 'F:/001/1/Digital_Life_Server/SentimentEngine/models/paimon_sentiment.onnx'  # 本地目录路径
